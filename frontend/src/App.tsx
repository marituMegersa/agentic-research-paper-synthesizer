...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Academic Research Paper Synthesizer</h1>
      <p style={{ color: '#666' }}>Multi-agent scientific literature review, paper summarization, citation graph mapping, and hypothesis generation.</p>
